...
exports.InterfaceRedeSocial = void 0;
class InterfaceRedeSocial {
    imprimirMenuInterface(apelido) {
        const menu = `
+---------------------------------------+
...
exports.InterfaceRedeSocial = InterfaceRedeSocial;
;
